        ...
        <div class="block md:grid md:grid-cols-3 gap-5">
            ...
            <div class="col-span-full">
                ...
                <textarea id="description" name="description"
                    ...
                    placeholder="Write down your description..">{{ old('description') }}</textarea>
                @error('description')
                    <div class="mt-2 text-red-500">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="flex justify-end col-span-full">
                <button type="submit" class="me-4 px-5 py-2 bg-blue-800 text-blue-200 rounded shadow">Create</button>
            </div>
        </div>
